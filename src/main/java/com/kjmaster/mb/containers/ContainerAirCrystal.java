 ...
 */
public class ContainerAirCrystal extends Container {
    private IInventory playerInv;
    private TileEntityAirCrystal te;
    private int mana;
    public ContainerAirCrystal(IInventory playerInv, TileEntityAirCrystal te) {
        this.te = te;
