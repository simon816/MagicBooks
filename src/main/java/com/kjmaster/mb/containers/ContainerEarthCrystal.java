 ...
 */
public class ContainerEarthCrystal extends Container {
    private IInventory playerInv;
    private TileEntityEarthCrystal te;
    private int mana;
    public ContainerEarthCrystal(IInventory playerInv, TileEntityEarthCrystal te) {
        this.te = te;
