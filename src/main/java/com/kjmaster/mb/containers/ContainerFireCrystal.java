 ...
 */
public class ContainerFireCrystal extends Container {
    private IInventory playerInv;
    private TileEntityFireCrystal te;
    private int mana;
    public ContainerFireCrystal(IInventory playerInv, TileEntityFireCrystal te) {
        this.te = te;
