 ...
 */
public class TileEntityEarthCrystal extends TileEntity implements ITickable, ICapabilityProvider {
    ...
    public void update() {
        if(this.world != null) {
            TileEntityEarthCrystal te = (TileEntityEarthCrystal) world.getTileEntity(pos);
            if(!this.world.isRemote) {
                if(getHasConnection()) {
                    if(world.getBlockState(pos).getBlock().equals(ModBlocks.greaterEarthCrystalBlock)) {
