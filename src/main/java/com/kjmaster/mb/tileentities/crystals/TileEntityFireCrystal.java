 ...
 */
public class TileEntityFireCrystal extends TileEntity implements ITickable, ICapabilityProvider {
    ...
    public void update() {
        if(this.world != null) {
            TileEntityFireCrystal te = (TileEntityFireCrystal) world.getTileEntity(pos);
            if(!this.world.isRemote) {
                if(getHasConnection()) {
                    if(world.getBlockState(pos).getBlock().equals(ModBlocks.greaterFireCrystalBlock)) {
