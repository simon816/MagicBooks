 ...
 */
public class TileEntityGreaterEarthCrystal extends TileEntity implements ITickable {
    ...
    public TileEntityGreaterEarthCrystal() {
        this.connections = 0;
                ...
                if(te.getConnections() > 0) {
                    ...
                    for(int i = 0; i < posToSendManaTo.size(); i++) {
                        ...
                        if(entity instanceof TileEntityEarthCrystal) {
                            ...
                            if(earthCrystal.getCanRecieve() && this.storage.canExtract() && !earthCrystal.storage.isFull() && this.storage.getManaStored() >= (MANA_USE / posToSendManaTo.size())) {
                                earthCrystal.receiveMana(MANA_USE / posToSendManaTo.size());
