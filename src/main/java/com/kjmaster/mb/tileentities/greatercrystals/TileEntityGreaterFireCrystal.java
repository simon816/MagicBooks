...
/**
 * Created by pbill_000 on 14/08/2017.
 */
public class TileEntityGreaterFireCrystal extends TileEntity implements ITickable {
    ...
    public TileEntityGreaterFireCrystal() {
        this.connections = 0;
    ...
    public void update() {
        if(this.world != null) {
            TileEntityGreaterFireCrystal te = (TileEntityGreaterFireCrystal) world.getTileEntity(pos);
                ...
                if(te.getConnections() > 0) {
                    ...
                    for(int i = 0; i < posToSendManaTo.size(); i++) {
                        ...
                        if(entity instanceof TileEntityFireCrystal) {
                            ...
                            if(fireCrystal.getCanRecieve() && this.storage.canExtract() && !fireCrystal.storage.isFull() && this.storage.getManaStored() >= (MANA_USE / posToSendManaTo.size())) {
                                fireCrystal.receiveMana(MANA_USE / posToSendManaTo.size());
