...
public class CapabilityHandler {
    ...
    public static final ResourceLocation MANA = new ResourceLocation(Ref.MODID, "Mana");
    ...
    @SubscribeEvent
    public void attatchTECapability(AttachCapabilitiesEvent<TileEntity> event) {
        if(event.getObject() instanceof TileEntityWoodCutRune) {
            event.addCapability(MANA, new CapabilityMana(1000));
        }
    }
}
