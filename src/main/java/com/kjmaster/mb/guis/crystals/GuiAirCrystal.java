 ...
 */
public class GuiAirCrystal extends GuiContainer {

    private final ResourceLocation TEXTURE = new ResourceLocation(Ref.MODID, "textures/gui/container/air_crystal.png");

    private final TileEntityAirCrystal te;
    private ProgressBar progressBar;
    private IInventory playerInv;
    private World world;
    public GuiAirCrystal(IInventory playerInv, TileEntityAirCrystal te, World world) {
        super(new ContainerAirCrystal(playerInv, te));
        this.xSize = 176;
        this.ySize = 166;
        this.te = te;
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String s = I18n.format("container.air_crystal"); //Gets the formatted name for the block breaker from the language file - NOTE ADD "container.block_breaker=BlockEarthCrystal Breaker" to the language file (without quotes) and then delete this note
